        ...
        var rowItem = document.createElement('tr'); 
            ...
            const rowItemComplete = document.createElement('td'); 
                ...
                var rowItemCompleteButton = document.createElement('button');
                    ...
                    rowItemCompleteButton.addEventListener("click", function() {listItemFunctions.markComplete(taskListArray[i])});
            ...
            var rowItemEdit = document.createElement('td');
                rowItemEdit.addEventListener("click", function() {editListItem.loadModal(taskListArray[i])});
            ...
            var rowItemDelete = document.createElement('td');
                ...
                rowItemDelete.addEventListener("click", function() {listItemFunctions.deleteListItem(taskListArray[i])});
